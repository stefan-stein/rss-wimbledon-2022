...
write.csv(atp22, 'elo_ratings/atp22.csv', row.names = F)
write.csv(atp21, 'elo_ratings/atp21.csv', row.names = F)
write.csv(atp19, 'elo_ratings/atp19.csv', row.names = F)
write.csv(atp18, 'elo_ratings/atp18.csv', row.names = F)
```
...
```{r}
write.csv(wta22, 'elo_ratings/wta22.csv', row.names = F)
write.csv(wta21, 'elo_ratings/wta21.csv', row.names = F)
write.csv(wta19, 'elo_ratings/wta19.csv', row.names = F)
write.csv(wta18, 'elo_ratings/wta18.csv', row.names = F)
```
